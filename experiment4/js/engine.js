...
function setup() {
  ...
  createP("Arrow keys scroll. Click on Lighthouses to lightup the ocean.").parent("container");
...
function mouseClicked() {
  ...
  // Check if the clicked tile contains Lighthouse
  if (window.p3_tileClicked) {
    let isLighthouse = window.p3_tileClicked(world_pos[0], world_pos[1]);
  }
  return false;
}
